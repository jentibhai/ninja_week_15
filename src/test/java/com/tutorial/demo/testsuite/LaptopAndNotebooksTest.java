...
public class LaptopAndNotebooksTest extends BaseTest {
    ...
    public void verifyThatUserPlaceOrderSuccessfully () throws InterruptedException {
        ...
        laptopsAndNotebooks.enterName("nehal");
        laptopsAndNotebooks.enterLastName("Vyas");
        laptopsAndNotebooks.enterEmail("paijanehal.com");
        laptopsAndNotebooks.enterTelephone("123456");
        laptopsAndNotebooks.enterAddress("ertyuijh");
        laptopsAndNotebooks.enterCity("London");
        laptopsAndNotebooks.enterPostcode("wd19 5aq");
